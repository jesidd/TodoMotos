...
const Home: React.FC = () => {
  ...
  return (
    <>
      <Header />
      <div className=" h-auto w-full bg-white top-[164px] scrollbar-hidden">
        <Banner />

        <div className="flex justify-start h-auto flex-wrap w-[90%] lg:w-[86.7%] md:w-[80%] gap-12 relative pt-30 pb-15 mx-auto">
          {status === "pending" ? (
            <LoaderCircle />
          ) : status === "error" ? (
            "Error"
